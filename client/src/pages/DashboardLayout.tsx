...
const allMenuItems: MenuItem[] = [
  ...
  { icon: Bell,            label: "Notifications",  path: "/notifications", roles: ["admin","pharmacist","procurement_officer","supplier","accountant"] },
  // Pharmacist only (+ admin)
  { icon: Package,         label: "Inventory",      path: "/inventory",    roles: ["admin","pharmacist"] },
  { icon: ClipboardList,   label: "Requisitions",   path: "/requisitions", roles: ["admin","pharmacist"] },
  { icon: TrendingUp,      label: "AI Forecasting", path: "/forecasting",  roles: ["admin","pharmacist","procurement_officer"] },
  // Procurement only (+ admin)
  { icon: ShoppingCart,    label: "Procurement",    path: "/procurement",  roles: ["admin","procurement_officer","supplier"] },
  { icon: Truck,           label: "Suppliers",      path: "/suppliers",    roles: ["admin","procurement_officer"] },
  // Accountant only (+ admin)
  { icon: DollarSign,      label: "Financial",      path: "/financial",    roles: ["admin","accountant"] },
  { icon: BarChart3,       label: "Reports",        path: "/reporting",    roles: ["admin","accountant"] },
  // Admin only
