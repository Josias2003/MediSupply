...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.18),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(16,185,129,0.16),_transparent_24%),linear-gradient(135deg,#f8fbff_0%,#eef5ff_42%,#f5f7fb_100%)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.08),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(16,185,129,0.06),_transparent_32%),radial-gradient(circle_at_center_right,_rgba(59,130,246,0.04),_transparent_40%)] dark:bg-slate-950">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-4 py-10 sm:px-6 lg:px-8">
        <button
          type="button"
          onClick={() => toggleTheme?.()}
          className="absolute top-4 right-4 inline-flex items-center gap-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-100/80 dark:bg-slate-800/90 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-100 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
        >
        ...
        <div className="w-full">
          ...
          <section className="flex flex-col justify-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-slate-950 dark:text-slate-100">Supply Chain Management System</p>
              </div>
            </div>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              {QA_ITEMS.map((item, index) => (
                <div
                  key={index}
                  className="rounded-3xl border border-white/70 dark:border-slate-700/70 bg-white/58 dark:bg-slate-900/50 p-5 backdrop-blur-xl shadow-[0_20px_55px_rgba(148,163,184,0.18)] dark:shadow-[0_20px_55px_rgba(0,0,0,0.3)]"
                >
                  <div className="flex items-center justify-between">
                    <div className="rounded-2xl bg-slate-900/95 dark:bg-slate-800 p-2.5 text-white shadow-lg">
                      <item.icon className="w-4 h-4" />
                    </div>
                    <span className="text-[11px] uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">Q&A {index + 1}</span>
                  </div>
                  <p className="mt-5 text-sm font-semibold text-slate-900 dark:text-slate-100">{item.question}</p>
          ...
          <section className="flex items-center justify-center lg:justify-end">
            <div className="w-full max-w-md rounded-[32px] border border-white/70 dark:border-slate-700/70 bg-white/72 dark:bg-slate-900/80 p-6 backdrop-blur-2xl shadow-[0_30px_90px_rgba(15,23,42,0.14)] dark:shadow-[0_30px_90px_rgba(0,0,0,0.4)] sm:p-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1 h-11 border-white/70 dark:border-slate-700/70 bg-white/80 dark:bg-slate-800/80"
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      <Input
                        ...
                        className="h-11 border-white/70 dark:border-slate-700/70 bg-white/80 dark:bg-slate-800/80 pr-10"
                        onKeyDown={e => e.key === "Enter" && handleLogin()}
                      />
                      <button
                        type="button"
              ...
              {screen === "otp" && (
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    placeholder="000000"
                    className="h-12 border-white/70 dark:border-slate-700/70 bg-white/80 dark:bg-slate-800/80 text-center font-mono text-2xl tracking-[0.45em]"
                    maxLength={6}
              ...
              {screen === "forgot_sent" && (
                <div className="space-y-4 text-center">
                  ...
                  <Button className="h-11 w-full rounded-xl bg-slate-950 text-white hover:bg-slate-900 dark:bg-slate-700 dark:hover:bg-slate-600" onClick={() => setScreen("login")}>
                    Back to sign in
                  </Button>
                </div>
              )}
          ...
          <footer className="mt-10 rounded-[28px] border border-white/70 dark:border-slate-700/70 bg-white/60 dark:bg-slate-900/50 p-6 backdrop-blur-xl shadow-[0_18px_45px_rgba(148,163,184,0.16)] dark:shadow-[0_18px_45px_rgba(0,0,0,0.3)]">
            <div className="grid gap-6 md:grid-cols-3">
              <div>
                <p className="text-sm font-semibold text-slate-950 dark:text-slate-100">Polyclinique de l'Etoile</p>
              ...
              <div>
                <p className="text-sm font-semibold text-slate-950 dark:text-slate-100">Clinic Services</p>
              ...
              <div>
                <p className="text-sm font-semibold text-slate-950 dark:text-slate-100">Contact Info</p>
                <div className="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-400">
