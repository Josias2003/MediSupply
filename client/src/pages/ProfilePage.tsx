...
const ROLE_COLORS: Record<string, string> = {
  ...
  procurement_officer: "bg-green-100 text-green-800",
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <Card className="p-5 flex items-center gap-4">
        ...
        <Badge className={`${ROLE_COLORS[me?.role || ""] || "bg-gray-100 text-gray-800"} shrink-0`}>
          ...
          <Card className="p-6 space-y-4">
            ...
            <div>
              ...
              {pwdForm.next.length > 0 && (
                <div className="mt-1 flex gap-1">
                  {[8, 12, 16].map(len => (
                    <div key={len} className={`h-1 flex-1 rounded-full ${pwdForm.next.length >= len ? "bg-green-400" : "bg-gray-200"}`} />
                  ))}
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {pwdForm.confirm && pwdForm.next && (
                <p className={`text-xs mt-1 ${pwdForm.next === pwdForm.confirm ? "text-green-600" : "text-red-500"}`}>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <Badge className={`mt-2 ${me?.twoFactorEnabled ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-600"}`}>
